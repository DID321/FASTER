...
def parameter_setting():
    ...
    # log 文件夹
    parser.add_argument('--log-path', type=str, default='./Classification/logs/Resnet18_SOC')
    # 保存权重文件夹
    parser.add_argument('--save-path', type=str, default='./Classification/logs/Resnet18_SOC')
    # 训练图像尺寸
    ...
    parser.add_argument('--weights', type=str, default='./Classification/weights/resnet18-f37072fd.pth', help='initial weights path')
    # 是否冻结head以外所有权重
...
def main():
    ...
    train_dataset = SARDataSet(data_root=cfg["data_path"], img_txt_path=cfg["test_txt_path"], classes=cfg["names"],
